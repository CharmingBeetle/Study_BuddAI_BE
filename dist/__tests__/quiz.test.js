...
describe("GET /quizzes/:user_id", () => {
    test("200", () => __awaiter(void 0, void 0, void 0, function* () {
        const { body } = yield (0, supertest_1.default)(app_1.default).get("/api/quizzes/3").expect(200);
    ...
    test("200", () => __awaiter(void 0, void 0, void 0, function* () {
        const { body } = yield (0, supertest_1.default)(app_1.default).get("/api/quizzes/1").expect(200);
    ...
    test("400: Responds with bad request when an invalid request is made", () => __awaiter(void 0, void 0, void 0, function* () {
        const { body } = yield (0, supertest_1.default)(app_1.default).get("/api/quizzes/banana").expect(400);
    ...
    test("404: Responds with not found when a valid request when is made and the record does not exist", () => __awaiter(void 0, void 0, void 0, function* () {
        const { body } = yield (0, supertest_1.default)(app_1.default).get("/api/quizzes/799").expect(404);
